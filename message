...
function Chloex:Window(GuiConfig)
    ...
    DropShadowHolder.ZIndex = 0
    DropShadowHolder.Name = "DropShadowHolder"
    DropShadowHolder.Parent = NexUI

    DropShadowHolder.Position = UDim2.new(0, (NexUI.AbsoluteSize.X // 2 - DropShadowHolder.Size.X.Offset // 2), 0,
        (NexUI.AbsoluteSize.Y // 2 - DropShadowHolder.Size.Y.Offset // 2))
