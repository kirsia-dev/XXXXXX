...
local ConfigFile = "NexHub/Config/" .. gameName .. ".json"
...
function Chloex:Window(GuiConfig)
    ...
    local NexUI = Instance.new("ScreenGui");
    local DropShadowHolder = Instance.new("Frame");
    local DropShadow = Instance.new("ImageLabel");
    ...
    NexUI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    NexUI.Name = "NexUI"
    NexUI.ResetOnSpawn = false
    NexUI.Parent = game:GetService("CoreGui")
    ...
    DropShadowHolder.ZIndex = 0
    DropShadowHolder.Name = "DropShadowHolder"
    DropShadowHolder.Parent = Chloex  -- FIX: Chloeex -> Chloex

    DropShadowHolder.Position = UDim2.new(0, (Chloex.AbsoluteSize.X // 2 - DropShadowHolder.Size.X.Offset // 2), 0,
        (Chloex.AbsoluteSize.Y // 2 - DropShadowHolder.Size.Y.Offset // 2))
    ...
    -- Border ungu untuk tombol Close
    ...
    function GuiFunc:DestroyGui()
        if CoreGui:FindFirstChild("NexUI") then
            NexUI:Destroy()
        end
    end
    ...
    Close.Activated:Connect(function()
        ...
        DialogBorder.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
        ...
        CancelBorder.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
        CancelBorder.Parent = Cancel

        Yes.MouseButton1Click:Connect(function()
            if Chloex then Chloex:Destroy() end
